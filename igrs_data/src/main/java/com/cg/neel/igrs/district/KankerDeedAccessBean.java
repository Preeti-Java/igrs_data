...
@Entity
@Table(name = "KankerDeed")
public class KankerDeedAccessBean extends CommonDeedAccessBean{
	 ...
	 */
	public static KankerDeedAccessBean of(String fileId, String volumeNo, BookNoAccessBean bookNoAccessBean,
		...
		KankerDeedAccessBean kankerDeedAccessBean = new KankerDeedAccessBean();
		kankerDeedAccessBean.setFileId(fileId);
		kankerDeedAccessBean.setVolumeNo(volumeNo);
		kankerDeedAccessBean.setBookNoAccessBean(bookNoAccessBean);
		kankerDeedAccessBean.setDocumentNo(documentNo);
		kankerDeedAccessBean.setPageFrom(pageFrom);
		kankerDeedAccessBean.setPageTo(pageTo);
		kankerDeedAccessBean.setDateOfRegistration(dateOfRegistration);
		kankerDeedAccessBean.setYearAccessBean(yearAccessBean);
		kankerDeedAccessBean.setDocumentTypeAccessBean(documentTypeAccessBean);
		kankerDeedAccessBean.setRegistrationDistrictAccessBean(registrationDistrictAccessBean);
		kankerDeedAccessBean.setSrLocationAccessBean(srLocationAccessBean);
		kankerDeedAccessBean.setRevenueDistrictAccessBean(revenueDistrictAccessBean);
		kankerDeedAccessBean.setDistrictAccessBean(districtAccessBean);
		kankerDeedAccessBean.setSubDistrictAccessBean(subDistrictAccessBean);
		
		return kankerDeedAccessBean;
	}
